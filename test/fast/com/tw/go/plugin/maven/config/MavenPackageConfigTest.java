...
public class MavenPackageConfigTest {
    ...
    public void shouldValidateBounds(){
        ...
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.GROUP_ID, "com.tw"));
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.ARTIFACT_ID, "mypkg"));
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.POLL_VERSION_FROM, "1.2"));
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.POLL_VERSION_TO, "1.5"));
    ...
    public void shouldRejectInvalidBounds(){
        ...
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.ARTIFACT_ID, "mypkg"));
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.POLL_VERSION_FROM, "1.2"));
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.POLL_VERSION_TO, "1.1"));
        MavenPackageConfig mavenPackageConfig = new MavenPackageConfig(packageConfigs);
        ValidationResult errors = new ValidationResult();
        mavenPackageConfig.validate(errors);
    ...
    public void shouldRejectEqualBounds(){
        ...
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.ARTIFACT_ID, "mypkg"));
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.POLL_VERSION_FROM, "1.2"));
        packageConfigs.addConfiguration(new Property(MavenPackageConfig.POLL_VERSION_TO, "1.2"));
        MavenPackageConfig mavenPackageConfig = new MavenPackageConfig(packageConfigs);
        ValidationResult errors = new ValidationResult();
        mavenPackageConfig.validate(errors);
        assertFalse(errors.isSuccessful());
